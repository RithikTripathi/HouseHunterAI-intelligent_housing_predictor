...
## ---------------- Steps involved for Model Trainer ---------------------
#1 Loading Transformed Training & Testing Dataset
#2 Reading Model Congig file
#3 Getting best model on training dataset
#4 Evaluating models on both Training and Testing datasets --> model object
#5 Loading Preprocessi8ng Object
#6 Custom model object by combining Preprocessing obj and Model obj
#7 Saving custom model object
#8 Return model_trianer_artifact
...
class ModelTrainer : 
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        try:
            ...
            logging.info(f"Splitting Training & Testing input and target features")
            # To get a specific element from an array, we use arr[r,c]
            ...
            # so this metric info contains the best model
