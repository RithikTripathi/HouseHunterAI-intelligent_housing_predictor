...
class ModelPusher:
    ...
    def export_model(self) -> ModelPusherArtifact:
        try:
            # evaluated model is nothing but the trained model we trained by model trainer
            ...
            # Note : Here we can add an additional cloud layer to save the model directly to cloud like Google, AWS, s3bucket etc
